...
var license = 'NTE4Njg3MzE0MDg5Nzc5OTYz',
...
second <= 1 ? window.location.href = "https://as-syariahbordir.github.io/" : $('#aktivasi').text(--second);
}, 1e3)
}
});
...
fixedMenu = 'undefined' == typeof fixedMenu || fixedMenu, $('#blogger-unang-main-nav').menublog(), $('#blogger-unang-main-nav .widget').addClass('show-menu'), $('.show-search').on('click', function () {
    ...
    }), $('a#as-syariahbordir').each(function () {
        var _0x6179x3 = $(this),
